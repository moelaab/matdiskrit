...
},
{
  "id": "data-types-10",
  "level": "2",
  "url": "data-types.html#data-types-10",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
  "body": "Boolean "
},
{
  "id": "data-types-12",
  "level": "2",
  "url": "data-types.html#data-types-12",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
  "body": "List "
},
{
  "id": "data-types-18",
  "level": "2",
  "url": "data-types.html#data-types-18",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
  "body": "Tuple "
},
{
  "id": "data-types-20",
  "level": "2",
  "url": "data-types.html#data-types-20",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
  "body": "set "
},
{
  "id": "data-types-22",
  "level": "2",
  "url": "data-types.html#data-types-22",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
  "body": "Set "
},
{
  "id": "data-types-26",
  "level": "2",
  "url": "data-types.html#data-types-26",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
  "body": "Dictionary "
...
},
{
  ...
  "number": "3.1",
  "title": "Combinatorics",
  "body": " Combinatorics   Factorial Function   factorial   The factorial of a non-negative integer , denoted by , is the product of all positive integers less than or equal to .  Compute the factorial of :     Combinations   combination   The combination is an unordered selection of objects from a set of objects.   Notes  Use combinations when order does not matter, such as determining possible Poker hands. The order in which a player holds cards does not affect the kind of hand. For example, the following hand is a royal flush: , , , , . The following hand is also a royal flush: , , , , .   Calculate the number of ways to choose elements from a set of :   List the combinations:   Note that the function arranges the numbers from to for its listing of combinations.   binomial   The binomial() function provides an alternative method to compute the number of combinations.     Permutations   permutation   A permutation is an ordered selection of objects from a set of objects.   Notes  Use permutations in situations where order does matter, such as when creating passwords. Longer passwords have more permutations, making them more challenging to guess by brute force.   To calculate the number of ways to choose elements from a set of when the order matters, use the Permutations() method.   List the permutations:   Note that the function arranges the numbers from to for its listing of permutations.  When , we can calculate permutations of elements.  Calculate the number of permutations of a set with elements:   List the permutations:   The following is an example of permutations of specified elements:   Choose :    "
},
{
...
{
  "id": "fig-traffic-light-fsm",
  "level": "2",
  "url": "sec-modeling-finite-state-machines.html#fig-traffic-light-fsm",
  "type": "Figure",
  "number": "12.2.3",
  "title": "",
